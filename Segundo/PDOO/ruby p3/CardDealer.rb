...
class CardDealer 
    ...
    def createSuppliesPackages() 
        ...
        @suppliesPackages.add(SuppliesPackage.new(1,100,10))
    end
    ...
    def createWeapons() 
       ...
       @weapons.add(Weapon.new("Carmen",WeaponType::PLASMA,500))  
    end
    ...
    def createShieldBoosters() 
       ...
       @shieldBoosters.add(ShieldBooster.new("Carmen",5.2,30))
    end
    ...
    def createEnemies() 
        ...
        @enemies.add(EnemyStarShip.new("Enemigo Carmen",1000,1,regularLoot0,lowDamage0));
