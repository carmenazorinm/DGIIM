	...
	class GameUniverse
		...
		def combatGo (station, enemy)
			...
			if (enemyWins)
				...
				#aqui es cuando el enemigo entrega el botín
				aLoot=enemy.loot
				hay_robo=@dice.queHayaRobo
				if(hay_robo)
					su=aLoot.reducirNSupplies
					w=aLoot.redcuirNWeapons
					sh=aLoot.reducirNShields
					h=aLoot.reducirNHangars
					m=aLoot.reducirNMedals
					bLoot=Loot.new(su,w,sh,h,m,b)
					station.setLoot(nLoot)
				else
