...
constexpr int
   num_items = 10 ;   // número de items a producir/consumir
...
{
  if(n_multiplos_5 == num)
  {
    cout << "Se han introducodp todos los multiplos de 5" << endl;
    return false;
  }else{
    if(num-n_anterior == 0){
        impresora.wait();
    }
    cout << "Se han insertado " << num-n_anterior << " multiplos de 5 nuevos..." << endl;
    n_anterior = num;
    return true;
  }
}
