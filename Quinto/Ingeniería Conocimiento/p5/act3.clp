...
(cd temperatura alta 37.5 38.5 100 100)  ; aproximadamente mas 38.5 -> CAMBIADO A 37.5 PARA TEMP ALTA
...
(cd edad infantil 0 0 5 12)
(cd edad joven 10 18 25 30)
(cd edad medio 28 40 50 60)
(cd edad mayor 55 65 100 100)
)
...
(regla 5 explicacion "Si el paciente es mayor y tiene fiebre alta, la dosis debe ser media para evitar riesgos")
)
...
(printout t "- Se va a aplicar la regla: " crlf ?text  crlf)
)
