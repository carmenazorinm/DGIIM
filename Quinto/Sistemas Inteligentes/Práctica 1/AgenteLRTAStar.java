...
public class AgenteLRTAStar extends AbstractPlayer{
	...
	public ACTIONS act(StateObservation stateObs, ElapsedCpuTimer elapsedTimer) {
	    ...
	    // vamos a guardar el mejor vecino (para movernos y para actualizar la tabla) 
	    ...
	    // actualizamos la heuristica del nodo_actual con la del mejor vecino	    
	    if (mejorValor != Float.MAX_VALUE) {
